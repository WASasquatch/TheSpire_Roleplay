...
export function ArcadeLauncher({ characterId, onLaunch, onClose }: {
  ...
  const cardStyle: React.CSSProperties = {
    ...
    background: "rgb(var(--keep-bg) / 1)", border: "1px solid rgb(var(--keep-border) / .6)",
  };
      ...
      >
        ...
        <div style={cardStyle}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 6, alignItems: "stretch" }}>
            ...
            {access === "forbidden" && <span style={{ fontSize: 12, color: T(0.6), textAlign: "center", maxWidth: 140 }}>Unavailable to you right now.</span>}
            {access === "ok" && (
              <button
        ...
        <div style={{ ...cardStyle, marginTop: 12, opacity: 0.55 }}>
          <div style={{ fontSize: 40, lineHeight: 1 }} aria-hidden>✦</div>
          <div style={{ flex: 1 }}>
