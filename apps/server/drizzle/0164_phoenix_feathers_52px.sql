...
--
-- Userlist neighbor overlap (the original concern that drove 0163)
-- was actually a userlist-row-density issue, not a feather-distance
-- one; at sm the wrapper is only ~49px tall and adjacent rows can't
-- be tightened any further without losing a readable click target.
-- Trading a slight feather-touch on the row gap for a clearly
-- visible Phoenix halo is the right call.
