-- Phoenix feathers at translate(0, -34px). Closer to center than
-- the original -44px (i.e. tucked INSIDE the .av frame rather than
-- pushed outside), so the feathers ride on the ring band itself
-- and sit visually inside the avatar's spinning halo rather than
-- forming an outer ring of their own.
