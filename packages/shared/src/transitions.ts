...
export const ROOM_TRANSITIONS: RoomTransition[] = [
  ...
  { key: "tv", label: "Television", cost: ROOM_TRANSITION_PRICE,
    description: "Scanlines bloom, then the picture is crushed top-and-bottom to a screaming white line — the next room blinks back the way an old cathode tube wakes." },
