...
export const PERMISSION_DESCRIPTIONS: Record<PermissionKey, string> = {
  ...
  edit_user_dob: "Correct another user's date of birth (audited; users cannot edit their own). An edit that makes an adult a minor logs them out so the age gates rebuild.",
  ...
  apply_create_server: "Submit an application to create a community server (one pending application at a time).",
...
export const PERMISSION_GROUPS: Record<PermissionKey, PermissionGroup> = {
  ...
  apply_create_server: "content_admin",
  review_server_applications: "content_admin",
  manage_any_server: "content_admin",
  ...
  view_admin_servers: "admin_panel_tabs",
