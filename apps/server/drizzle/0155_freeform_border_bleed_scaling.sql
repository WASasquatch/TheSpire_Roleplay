-- Tier-aware bleed scaling for free-form borders.
--
...
-- values, wrapping every bleed-bearing extent in
--   `calc(<native> * var(--b-spread, 1))`
-- The portal wrapper sets `--b-spread` per tier (see
...
.b-forest .lf1 { top: calc(-8px * var(--b-spread, 1)); left: 30%; animation: leafFall 4s ease-in infinite; }
.b-forest .lf2 { top: calc(-8px * var(--b-spread, 1)); left: 65%; animation: leafFall 4s ease-in infinite 1.3s; }
.b-forest .lf3 { top: calc(-8px * var(--b-spread, 1)); left: 45%; animation: leafFall 4s ease-in infinite 2.6s; }
...
@keyframes leafFall {
  ...
  15% { opacity: 1; }
  100% { transform: translateY(calc(110px * var(--b-spread, 1))) rotate(540deg) translateX(calc(20px * var(--b-spread, 1))); opacity: 0; }
}',
...
.b-phoenix-v4 .ft1  { transform: rotate(0deg)   translate(0, calc(-58px * var(--b-spread, 1))); animation-delay: 0s; }
.b-phoenix-v4 .ft2  { transform: rotate(30deg)  translate(0, calc(-58px * var(--b-spread, 1))); animation-delay: .11s; }
.b-phoenix-v4 .ft3  { transform: rotate(60deg)  translate(0, calc(-58px * var(--b-spread, 1))); animation-delay: .22s; }
.b-phoenix-v4 .ft4  { transform: rotate(90deg)  translate(0, calc(-58px * var(--b-spread, 1))); animation-delay: .33s; }
.b-phoenix-v4 .ft5  { transform: rotate(120deg) translate(0, calc(-58px * var(--b-spread, 1))); animation-delay: .44s; }
.b-phoenix-v4 .ft6  { transform: rotate(150deg) translate(0, calc(-58px * var(--b-spread, 1))); animation-delay: .55s; }
.b-phoenix-v4 .ft7  { transform: rotate(180deg) translate(0, calc(-58px * var(--b-spread, 1))); animation-delay: .66s; }
.b-phoenix-v4 .ft8  { transform: rotate(210deg) translate(0, calc(-58px * var(--b-spread, 1))); animation-delay: .77s; }
.b-phoenix-v4 .ft9  { transform: rotate(240deg) translate(0, calc(-58px * var(--b-spread, 1))); animation-delay: .88s; }
.b-phoenix-v4 .ft10 { transform: rotate(270deg) translate(0, calc(-58px * var(--b-spread, 1))); animation-delay: .99s; }
.b-phoenix-v4 .ft11 { transform: rotate(300deg) translate(0, calc(-58px * var(--b-spread, 1))); animation-delay: 1.1s; }
.b-phoenix-v4 .ft12 { transform: rotate(330deg) translate(0, calc(-58px * var(--b-spread, 1))); animation-delay: 1.21s; }
...
@keyframes dr2Ember {
  ...
  100% { transform: translate(calc(18px * var(--b-spread, 1)), calc(-32px * var(--b-spread, 1))) scale(.2); opacity: 0; }
}
@keyframes dr2EmberL {
  0% { transform: translate(0,0) scale(1); opacity: 1; }
  100% { transform: translate(calc(-18px * var(--b-spread, 1)), calc(-32px * var(--b-spread, 1))) scale(.2); opacity: 0; }
...
.b-celestial-v2 .ray { position: absolute; width: 3px; background: linear-gradient(to top, rgba(255,213,79,1), transparent); top: calc(-20px * var(--b-spread, 1)); left: 50%; margin-left: -1.5px; height: 22px; transform-origin: 50% 70px; border-radius: 2px; }
...
.b-celestial-v2 .wL { left: calc(-16px * var(--b-spread, 1)); top: 30%; transform: rotate(-30deg) scaleX(-1); animation: cl2Wing 2s ease-in-out infinite; }
.b-celestial-v2 .wR { right: calc(-16px * var(--b-spread, 1)); top: 30%; transform: rotate(30deg); animation: cl2Wing 2s ease-in-out infinite; }
...
.b-runic .glyph-ring { position: absolute; inset: calc(-16px * var(--b-spread, 1)); animation: runeOrbit 12s linear infinite; }
...
.b-runic::after { content: ""; position: absolute; inset: calc(-8px * var(--b-spread, 1)); border-radius: 50%; border: 1px solid rgba(79,195,247,.4); animation: runeRing 8s linear infinite reverse; }
...
@keyframes qOrbit {
  from { transform: rotate(0deg) translateX(calc(48px * var(--b-spread, 1))) rotate(0deg); }
  to { transform: rotate(360deg) translateX(calc(48px * var(--b-spread, 1))) rotate(-360deg); }
}',
  `updated_at` = unixepoch() * 1000
...
.b-fog-v2 .fog-band {
  position: absolute;
  left: calc(-30% * var(--b-spread, 1));
  right: calc(-30% * var(--b-spread, 1));
...
.b-fog-v2 .fog-halo { position: absolute; inset: calc(-20px * var(--b-spread, 1)); border-radius: 50%; background: radial-gradient(circle, rgba(220,230,255,.35) 30%, rgba(200,215,245,.18) 55%, transparent 75%); filter: blur(10px); z-index: 1; animation: fog2Halo 6s ease-in-out infinite; pointer-events: none; }
...
.b-neon-v2::before {
  content: ""; position: absolute; inset: calc(-8px * var(--b-spread, 1)); border-radius: 50%;
...
.b-sakura-v2 .petal-field {
  position: absolute;
  inset:
    calc(-22px * var(--b-spread, 1))
    calc(-16px * var(--b-spread, 1))
    calc(-26px * var(--b-spread, 1))
    calc(-16px * var(--b-spread, 1));
  border-radius: 50%;
  pointer-events: none;
  overflow: visible;
...
.b-sakura-v2 .petal-pile {
  position: absolute;
  left: 6%; right: 6%; bottom: calc(-5px * var(--b-spread, 1));
  height: 10px;
  pointer-events: none;
  border-radius: 999em;
  background:
...
@keyframes sk2Drop {
  ...
  8% { opacity: .95; }
  30% { transform: translate3d(calc(-10px * var(--b-spread, 1)), calc(30px * var(--b-spread, 1)), 0) rotate(60deg) scale(.82); opacity: 1; }
  55% { transform: translate3d(calc(12px * var(--b-spread, 1)), calc(64px * var(--b-spread, 1)), 0) rotate(180deg) scale(.85); opacity: .95; }
  78% { transform: translate3d(calc(-6px * var(--b-spread, 1)), calc(96px * var(--b-spread, 1)), 0) rotate(280deg) scale(.8); opacity: .7; }
  100% { transform: translate3d(0, calc(128px * var(--b-spread, 1)), 0) rotate(360deg) scale(.7); opacity: 0; }
}
@keyframes sk2Pile {
...
.b-storm .bz1 { top: calc(-12px * var(--b-spread, 1)); left: 20%; animation: stormBolt 3s ease-out infinite; }
.b-storm .bz2 { bottom: calc(-8px * var(--b-spread, 1)); right: 15%; animation: stormBolt 3s ease-out infinite 1.5s; }
